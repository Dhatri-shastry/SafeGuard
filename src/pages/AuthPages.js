...
import { GoogleAuthProvider, signInWithPopup } from "firebase/auth"; // ✅ only one import now
import {
  signInWithEmailAndPassword,
  createUserWithEmailAndPassword,
  sendPasswordResetEmail,
} from "firebase/auth"; // ✅ removed duplicate signInWithPopup
...
const AuthPages = ({ setCurrentUser, setCurrentPage }) => {
  ...
  // ✅ Google Login — force account selection popup
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        {mode !== "forgot" && (
          <>
            ...
            <button
              onClick={handleGoogleLogin} // ✅ fixed the function name
              disabled={loading}
